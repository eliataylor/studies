...
// Find the optionsTable in displayPackingOptions() function and add the capacity option:
    ...
    const optionsTable = [
        ...
        ['--capacity <number>', 'Container capacity for knapsack problems', 'width*height'],
...
// Also add a new example specifically for knapsack:
    Logger.subsection('2. Value Optimization (Knapsack)');
    console.log(chalk.blue('npm run packing-test -- --algorithms "knapsack" --count 50 --item-type weighted --capacity 1000'));
